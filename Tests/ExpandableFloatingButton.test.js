...
import ExpandableFloatingButton from '../src/components/ExpandableFloatingButton'
...
describe("ExpandableFloatingButtonTests", () => {
    test("Renders correctly", async () => {
        const tree = renderer.create(
            <ExpandableFloatingButton items={{map: jest.fn()}} icon={jest.fn()} />
        ).toJSON(); 
